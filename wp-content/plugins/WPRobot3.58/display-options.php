...
<?php } ?>
	...
	<div style="width:25%;float:right;";>
		...
		<div class="expld">
			...
			<a target="_blank" href="http://paydotcom.net/r/114163/thoefter/26909274/"><b>SpinnerChief Special Discount</b></a><br/>Automatically rewrite WP Robot posts.<br/><br/>',"wprobot") ?>
	...
	<h3 style="text-transform:uppercase;border-bottom: 1px solid #ccc;"><?php _e("Rewriting","wprobot") ?></h3>
		...
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 		
			<tr valign="top"> 
				...
				<td>	<!--
				<?php print_r($options['wpr_rewrite_active']); ?><br/><br/>
				
				<?php print_r($_POST['wpr_rewrite_active']); ?><br/><br/>
				
				<input name="wpr_rewrite_active" type="checkbox" value="tbs" id="tbs" <?php if ($options['wpr_rewrite_active']=='tbs') {echo 'checked';} ?>><label for="tbs">TheBestSpinner</a> 
				<input name="wpr_rewrite_active" type="checkbox" value="sc" id="sc" <?php if ($options['wpr_rewrite_active']=='sc') {echo 'checked';} ?>><label for="sc">SpinnerChief</a> 
				<input name="wpr_rewrite_active" type="checkbox" value="schimp" id="schimp" <?php if ($options['wpr_rewrite_active']=='schimp') {echo 'checked';} ?>><label for="schimp">SpinChimp</a> 
				<input name="wpr_rewrite_active" type="checkbox" value="Yes" id="Yes" <?php if ($options['wpr_rewrite_active']=='Yes') {echo 'checked';} ?>><label for="Yes">UCG</a> 
					-->		
	...
	<p><strong>SpinChimp Rewriter</strong>&nbsp;&nbsp;&nbsp;<a href="http://542c4iv7ejm1cq6-snxenhk6kz.hop.clickbank.net/" target="_blank"><?php _e("Details and Signup &rarr;","wprobot") ?></a></p>		
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 			
			<tr <?php if($options['wpr_schimp_rewrite_email'] == "" && $options['wpr_rewrite_active']!='No') {echo 'style="background:#F8E0E0;"';} ?> valign="top"> 
				...
				<td><input size="40" name="wpr_schimp_rewrite_email" type="text" id="wpr_schimp_rewrite_email" value="<?php echo $options['wpr_schimp_rewrite_email'] ;?>"/>
					<a class="tooltip" href="http://542c4iv7ejm1cq6-snxenhk6kz.hop.clickbank.net/">?<span><?php _e('Click this link to get to the sign up page of the SpinChimp.com rewriting API supported by WP Robot.',"wprobot") ?></span></a>						
			</td> 
			</tr>	
