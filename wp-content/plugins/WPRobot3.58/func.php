...
function wpr_sc_rewrite($article, $user, $pw, $quality, $keyword, $protected, $port){
	
	$url = "http://api.spinnerchief.com/apikey=ca01285820b24905b&username=$user&password=$pw&spintype=1&protecthtml=0&spinhtml=0&original=1&spinfreq=1&wordquality=$quality&protectwords=$keyword,".urlencode($protected)."";
