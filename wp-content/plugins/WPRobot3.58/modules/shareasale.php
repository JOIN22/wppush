...
<?php
if ($exists == true) {
    echo 'The required "datafeed.csv" file has been found inside your WPRobot3 directory.';
} else {
    echo 'The required "datafeed.csv" file has not been found inside your WPRobot3 directory!';
}
?>
