...
function wpr_install_function($email) {
	...
	$response = 'developer###INSERT INTO {wpr_template} ( type, typenum, content, title, comments_amazon, comments_flickr, comments_yahoo, comments_youtube, name ) VALUES  ( \'amazon\', \'0\', \'
	
<h3>{title}</h3>
<a href="{url}" rel="nofollow"><img src="{largeimage}" /></a>
...
<p>
<a href="{url}" rel="nofollow"><h2><span style="color: #ff6600;">GET MORE INFORMATION CLICK HERE</span></h2></a>
</p>
