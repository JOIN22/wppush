...
if (!class_exists('gdFunctionsGDPT')) {
    class gdFunctionsGDPT {
        /**
        ...
        function get_folder_size($path) {
            ...
            $ret = 0;
            foreach(glob($path."/*") as $fn)
                $ret += gdFunctionsGDPT::get_folder_size($fn);
 ...
 */
function gd_is_user_admin() {
    return current_user_can('manage_options');
}

if (!function_exists("is_super_admin")) {
    function is_super_admin() { return is_site_admin(); }
}

if (!function_exists("is_site_admin")) {
    function is_site_admin() { return true; }
}
...
if (!class_exists("gdSortObjectsArrayGDPT")) {
    class gdSortObjectsArrayGDPT {
        var $properties;
        var $sorted;

        function gdSortObjectsArrayGDPT($objects_array, $properties = array()) {
